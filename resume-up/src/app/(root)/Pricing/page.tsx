...
const page = () => {
    ...
    <div className="flex justify-between max-w-6xl mx-auto px-4 py-10" >
        <div className="ourStory flex-1 mr-20">
          ...
          <h1 className="text-2xl mb-6 text-resumeup">Coming soon to ResumeUp...</h1>
          ...
          <div className="flex justify-center mt-4"><Button className="secondary-button"  disabled>Coming Soon</Button></div>
        </div>
        <div className="homePic flex-1 mr-20">
          <div className="flex flex-col items-center">
            <img src="/homepage.png" alt="homepage" className="w-100 h-100 mb-2" />
          </div>
