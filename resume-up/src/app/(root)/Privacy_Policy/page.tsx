const page = () => {
  return <div className="max-w-6xl mx-auto px-4 py-10">
    ...
    <p className="text-lg ml-3">While using our Service, we may ask you to provide us with certain personally identifiable information that can
        be used to contact or identify you (Personal Data). Personally identifiable information may include, but is
        not limited to:</p>
    <ul>
        <li className="text-lg ml-3">&nbsp; •Email address</li>
        <li className="text-lg ml-3">&nbsp; •First name and last name</li>
        <li className="text-lg ml-3">&nbsp; •Phone number</li>
    ...
    <p className="text-lg ml-3">Additionally, we may use third-party services to assist us in analyzing how our Service is used. These services may collect information about your use of our Service but do not access, use, or share your personal information for any other purpose.</p>
