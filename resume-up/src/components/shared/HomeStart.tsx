  ...
  return (
    <div className="flex items-center px-4 py-10">
        ...
        <div className="flex-1 px-10 text-center mr-10">
            ...
            <Link href={"/Resume_Builder"}><button className="mt-10 px-8 py-4 bg-green-500 hover:bg-green-600 text-white text-3xl font-semibold rounded-full shadow-lg transition duration-300 ease-in-out">Start</button></Link>
        </div>
    </div>
  );
};
